...
const modulename = "navbarDropdown # ";
        ...
        <div ref={dropDownRef} className="relative">
            ...
            { isOpen && (
                <ul className=" absolute left-0 top-6 w-[200px] border-b border-x border-zinc-300">
                    <li className=" bg-slate-50 hover:bg-slate-200 border-b border-slate-300" key="MANAGEBOOKS">
                        <Link href="/adminbooks" className=" mx-2 text-zinc-900 mr-auto hover:font-bold">Gérer les livres</Link>
                    </li>
                    <li className=" bg-slate-50 hover:bg-slate-200 border-b border-slate-300" key="MANAGEUSERS">
