...
export default function notfound() {
  return (
    <div className="flex flex-col grow pt-44 text-center bg-gray-700">
        ...
        <p className=" my-4 text-white px-8">Contactez l'administrateur au 06.88.33.55.66<br/>
        ...
        <p className=" my-4 text-white px-8">Please contact the site admin on 06.88.33.55.66<br/>
        ...
        <Link href="/" className=" text-white font-bold text-2xl mb-10">Return Home</Link>
    </div>
  )
}
